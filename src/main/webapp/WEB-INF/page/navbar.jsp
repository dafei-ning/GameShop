		...
		<div class="collapse navbar-collapse" id="myNavbar">
			...
			<ul class="nav navbar-nav">
				<li><img src="<c:url value="/resource/images/gameshopicon.png"/>"
					width="232px" height="50px" alt="logo-image">
				</img></li>
				
				<li><a href=" <c:url value="/index" />">Home <span class="glyphicon glyphicon-menu-down"></span> 
				    </a><i class="icon-angle-down"></i></li>
				<li><a href=" <c:url value="/getAllProducts" />">Product List <span class="glyphicon glyphicon-menu-down"></span> 
				    </a><i class="icon-angle-down"></i></li>
				<li><a href=" <c:url value="/aboutus" />">About 
				    <span class="glyphicon glyphicon-menu-down"></span> </a><i class="icon-angle-down"></i></li>
				<!-- Only admin can view this link -->
				<security:authorize access="hasRole('ROLE_ADMIN')">
					<li><a href=" <c:url value="/admin/product/addProduct" />">Add Product <span class="glyphicon glyphicon-menu-down"></span> 
					</a><i class="icon-angle-down"></i></li>
				</security:authorize>
			</ul>
